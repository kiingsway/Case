...
<body>
    ...
    $user_check_query = "SELECT id, nome, rg, cpf, nascimento, categoria, situacao, cidade, estado, telefone, celular, email, senha FROM pf WHERE id=".$_POST['btnEditarPF']; 
    ...
    <nav class="red lighten-1" role="navigation"> 
      <div class="nav-wrapper container">
        ...
        <?php $nomeCompleto = $user['nome']; ?>
          <a class="breadcrumb">Editando: <div class="chip red darken-1"><?php echo $nomeCompleto; ?></div>
        </div>
      </div>
    </nav>
    <!-- Fim Breadcrumb -->
                ...
                <form method="POST" action="#" class="col s12">
                    <div class="row">                        
                        <div class="input-field col s1 hoverable">
                            <input disabled type="text" name="txtId" value=<?php echo $user['id']; ?>>
                            <label>id</label>
                        </div>
                        <div class="input-field col s5 hoverable">
                            <!-- <?php  echo '<p class="red">'.$nomeCompleto.'</p>' ?>-->
                            <input type="text" name="txtNomePF" value=<?php echo "'".$nomeCompleto."'"; ?>>
                            <label>Nome</label>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s4 hoverable">
                            <input type="password" name="txtSenhaPF" value=<?php echo "'".$user['senha']."'" ?>>
                            <label>Senha de acesso</label>
                        </div>
                    </div>
                    <div class="center"><button class="waves-effect waves-light btn-large" type="submit" name="btnEditarPF"><i class="material-icons">edit</i>Editar</button>
                    </div>
                </form>
            </div>
        </div>
