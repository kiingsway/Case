...
<body>
   <!-- Carrega e insere o cabeçalho do site -->
		...
		$query = "SELECT * FROM tb_cursos WHERE id=".$_POST['btnEditarCursos'];
			...
			<form method="POST" action="#" class="col s12">
				<div class="row">
					<div class="input-field col s6 hoverable">
						<input type="text" name="txtNomeCurso" class="ative" value=<?php echo '"'.$user['nomeCurso'].'"'; ?>>
				...
				<div class="row">
					<div class="input-field col s3 hoverable">
						<input type="text" name="txtDataInicial" class="datepicker" value=<?php echo '"'.$user['dataInicial'].'"'; ?>>
						<span class="helper-text" data-error="wrong" data-success="right">Data inicial do curso</span>

					</div>
					<div class="input-field col s3 hoverable">
							<input type="text" name="txtHoraInicial" class="timepicker" value=<?php echo '"'.$user['horaInicial'].'"'; ?>>
							<span class="helper-text" data-error="wrong" data-success="right">Hora Inicial do Curso</span>
					</div>
					<div class="input-field col s3 hoverable">
						<input type="text" name="txtDataFinal" class="datepicker" value=<?php echo '"'.$user['dataFinal'].'"'; ?>>
						<span class="helper-text" data-error="wrong" data-success="right">Data Final do Curso</span>
					</div>
					<div class="input-field col s3 hoverable">
							<input type="text" name="txtHoraFinal" class="timepicker" value=<?php echo '"'.$user['horaFinal'].'"'; ?>>
				...
				<div class="row">
					<div class="input-field col s4 hoverable">
						<input type="number" name="txtVagas" value=<?php echo '"'.$user['vagas'].'"'; ?>>
						<label>Vagas</label>
					</div>
					<div class="input-field col s4 hoverable">
							<input type="number" name="txtCargaHoraria" value=<?php echo '"'.$user['cargaHoraria'].'"'; ?>>
							<label>Carga Horária</label>
					</div>
					<div class="input-field col s4 hoverable">
						<input type="number" name="txtFreqMinima" value=<?php echo '"'.$user['freqMinima'].'"'; ?>>
				...
				<div class="row">
					...
					<div class="input-field col s12">
						<table>
							<tr>
								<td class="hoverable"><input type="number" name="txtValor" id="txtValorCurso" value=<?php echo '"'.$user['valor'].'"'; ?>>
									<label for="txtValorCurso">Valor</label></td>
								<td class="hoverable"><input type="number" name="txtValorSocio" id="txtValorSocioCurso" value=<?php echo '"'.$user['valorSocio'].'"'; ?>>
									<label for="txtValorSocioCurso">Valor Sócio</label></td>
								<td class="hoverable"><input type="number" name="txtValorParceiro" id="txtValorParceiroCurso" value=<?php echo '"'.$user['valorParceiro'].'"'; ?>>
									<label for="txtValorParceiroCurso">Valor Parceiro</label></td>
								<td class="hoverable"><input type="number" name="txtValorNaoQuite" id="txtValorNaoSocioCurso" value=<?php echo '"'.$user['valorNaoQuite'].'"'; ?>>
									<label for="txtValorNaoSocioCurso">Valor Não Quite</label></td>
							</tr>
						</table>
					</div>
						<div class="row">
							...
							<div class="input-field col s3 hoverable">
								<input type="text" class="datepicker" name="txtVencimento" id="txtVencimentoCurso" value=<?php echo '"'.$user['vencimento'].'"'; ?>>
								<label for="txtVencimentoCurso">Vencimento</label>
							</div>
							<div class="input-field col s3 hoverable">
								<input type="number" name="txtNdias" id="txtNdiasCurso" value=<?php echo '"'.$user['nDias'].'"'; ?>>
								<label for="txtNdiasCurso">N dias</label>
							</div>
						</div>
						<div>
							 <!-- Switch -->
						...
						<br>
						<div>
							<button class="waves-effect waves-light btn-large" type="submit" name="btnCriarCurso"><i class="material-icons">add</i>Adicionar livro</button>
						</div><?php } ?>
				</div>
			</form>
		</div>
